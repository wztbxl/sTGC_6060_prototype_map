...
// Wed Mar 10 18:21:52 2021 by ROOT version 6.18/00
// from TTree sTGC_DataDst/sTGC_DataDst
// found on file: stgc_s07_phy01107117_dbg.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           mEvtID;
   Int_t           nFireChannel;
   Int_t           Channel_Number[9];   //[nFireChannel]
   Int_t           Strip_Number[9];   //[nFireChannel]
   Int_t           nFireTimeBin[9];   //[nFireChannel]
   Int_t           TimeBin[1000];
   Int_t           ADC[1000];
   ...
   TBranch        *b_Channel_Number;   //!
   TBranch        *b_Strip_Number;   //!
   TBranch        *b_nFireTimeBin;   //!
   TBranch        *b_TimeBin;   //!
   TBranch        *b_ADC;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("stgc_s07_phy01107117_dbg.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("stgc_s07_phy01107117_dbg.root");
      }
...
void sTGC_DataDst::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Channel_Number", Channel_Number, &b_Channel_Number);
   fChain->SetBranchAddress("Strip_Number", Strip_Number, &b_Strip_Number);
   fChain->SetBranchAddress("nFireTimeBin", nFireTimeBin, &b_nFireTimeBin);
